      ...
      <v-card class="mt-8 ml-4 mr-4" tile elevation="5">
        ...
        <v-row>
          ...
          <v-col xs="12" sm="12" md="7" lg="7"
            ><v-card-text
              >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
              erat sapien, sodales a tortor ut, viverra dictum massa. Praesent
              luctus neque dui, sed vulputate mi faucibus sed. Fusce commodo
              enim ac ex malesuada, in suscipit quam faucibus. Curabitur quis
              lectus metus. Sed fringilla quam et malesuada gravida. Nullam id
              metus arcu. Sed eu bibendum massa. Maecenas eget lacus eu mi
              blandit suscipit at eu ipsum. Vestibulum ante ipsum primis in
              faucibus orci luctus et ultrices posuere cubilia curae; Vestibulum
              id metus malesuada, commodo ligula sed, aliquet risus. Sed tempus
              sem id nibh pellentesque interdum. Aliquam tincidunt ipsum non est
              volutpat iaculis. In efficitur sapien et arcu varius, non varius
              arcu tempus.</v-card-text
            ></v-col
          ></v-row
        >
